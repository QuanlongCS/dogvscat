...
from models.model_fusion import get_fusion_model # 导入fusion模型
...
#损失与精确---------------------------------------------      
        ...
        print(f'Epoch {epoch}/{EPOCHS} Train-Loss: {train_loss:.4f} Train-Acc: {val_epoch_acc:.4f}')
        ...
        if val_epoch_acc > best_acc:
            ...
            torch.save(model.state_dict(), 'vgg16_cats_dogs-vgg-best.pth')
